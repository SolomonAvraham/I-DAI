...
export default function Navbar() {
  ...
  return (
    <div className="navbar  bg-slate-50 text-black shadow-black shadow-2xl px-4 py-2 z-50">
      <div className="flex-1 normal-case font-bold text-xl cursor-default">I-DAI</div>
