...
export default function TermsPopup({
  ...
  return (
    <div className="fixed  text-black  top-0 bottom-0 left-0 right-0 inset-0   bg-gray-900 bg-opacity-50 flex justify-center items-center z-50">
      <div  className="bg-white p-6   rounded-lg shadow-lg max-w-lg w-10/12 xs:11/12 lg:w-full relative">
        {/* Close Button */}
        <button
