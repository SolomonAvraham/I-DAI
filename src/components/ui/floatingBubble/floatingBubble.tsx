...
const FloatingBubble: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-5 left-5 flex flex-col items-center space-y-2">
      ...
      >
        <button
          ...
          className="absolute top-1 hover:scale-110 right-1 text-sm text-white bg-red-900 rounded-full w-5 h-5 flex items-center justify-center"
          aria-label="Close"
        >
          X
        </button>
